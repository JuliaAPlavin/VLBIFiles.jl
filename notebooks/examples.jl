...
uvtbl_difmap = @p uvtbl_full |> filter(_.stokes == :RR) |> map(
	# difmap puts all uv points into the right semiplane
	UV(_).u >= 0 ? _ : VLBI.conjvis(_)
)
...
@p uvtbl_difmap |>
	map(angle(visibility(_)) |> rad2deg) |>
...
manifest_format = "2.0"
project_hash = "a9600e9f7482c02c0abfd23ee973a3170ca0a53f"
...
[[deps.Difmap]]
deps = ["DataPipes", "FlexiMaps", "Ghostscript_jll", "ImageMagick_jll", "difmap_jll"]
git-tree-sha1 = "9ef6267a378c9a7467f7557f1dbd1c021a9e967f"
...
git-tree-sha1 = "0b497b58cf2a1eecfe893f8c2369994d0785df17"
...
git-tree-sha1 = "b7a96bfb5d58b1fdc230944520ec28b9a0e323d1"
uuid = "a884e8af-a1e7-4ed8-8a37-289263ed986d"
version = "0.1.3"
weakdeps = ["Dates", "Statistics", "Unitful"]

    [deps.IntervarrrSets.extensions]
    DatesStatisticsExt = ["Dates", "Statistics"]
    UnitfulExt = "Unitful"
...
[[deps.PGPLOT_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "Libdl", "libpng_jll"]
git-tree-sha1 = "7f956e78acf82da25e0a3f4e1f313cba9f1c0022"
...
[[deps.Uncertain]]
deps = ["Accessors"]
git-tree-sha1 = "bc5cc33ac501a2a3c5291ebdfb1f4ce325589abb"
...
[[deps.VLBIData]]
deps = ["AccessorsExtra", "DataManipulation", "InterferometricModels", "StaticArrays", "Statistics", "StructArrays", "StructHelpers", "Uncertain", "Unitful"]
git-tree-sha1 = "ef2d797973d71d70ae123e42e859c7f3773b432b"
...
git-tree-sha1 = "3608058e7da85290993c76b77879e6bf5ca58725"
...
git-tree-sha1 = "209f73df4d84ba3ec4232168a9795caf5f5ebf07"
...
[[deps.difmap_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "Libdl", "Ncurses_jll", "PGPLOT_jll", "Xorg_libX11_jll"]
git-tree-sha1 = "b2a606ef672c59b0b1c8c8a51cca97bcd6cc71e8"
